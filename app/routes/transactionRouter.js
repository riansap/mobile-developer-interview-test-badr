 ...
 * @property {integer} open_vial - Open Vial - eg:0
 * @property {integer} close_vial - Close Vial - eg:0
 */
...
/**
 * @typedef TransactionInjection
 * @property {string} dose_1 - Dose 1 (people) - eg:10
 * @property {string} dose_2 - Dose 2 (people) - eg:20
 * @property {string} dose_booster - Dose Booster (people) - eg:15
 * @property {string} dose_routine - Dose Routine (people) - eg:100
 */
...
/* PUT transaction update dose. */
/**
 * This function comment is parsed by doctrine
 * @route PUT /transactions/{id}/injection
 * @group Transaction - Operations about injection
 * @param {TransactionInjection.model} data.body Create - Transaction Injection
 * @returns {object} 200 - {}
 * @returns {object} 404 - {
 *   "error": "Data not found"
 * }
...
transactionRouter.get('/:entity_id/export-excel',
  transactionController.exportExcelByEntity
)
