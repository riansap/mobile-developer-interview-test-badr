...
import * as transactionTypeController from '../controllers/transactionTypeController'
import models from '../models'
import parameterModel from '../helpers/parameterModel'
import * as transactionTypeValidator from '../validators/transactionTypeValidator'
...
transactionTypeRouter.post(
  '/',
  validate(transactionTypeValidator.create),
  parameterModel.define(TransactionType),
...
transactionTypeRouter.put(
  '/:id',
  validate(transactionTypeValidator.update),
  parameterModel.define(TransactionType),
...
transactionTypeRouter.get(
  '/:id/transaction_reasons',
  transactionTypeController.listReason
)
