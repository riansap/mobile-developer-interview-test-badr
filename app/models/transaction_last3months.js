...
module.exports = (sequelize, DataTypes) => {
  ...
  class TransactionLast3Month extends Model {
    /**
  ...
  TransactionLast3Month.init({
    ...
    sequelize,
    modelName: 'TransactionLast3Month',
    tableName: 'transactions_last_3months',
    paranoid: true,
    deletedAt: 'deleted_at',
  })

  TransactionLast3Month.addHook('beforeFind', (options) => {
  ...
  TransactionLast3Month.getVirtualAttribute = function () {
    return [
      'created_at',
      'updated_at',
      'closing_qty',
  ...
  sequelizePaginate.paginate(TransactionLast3Month)

  return TransactionLast3Month
}
